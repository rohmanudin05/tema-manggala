...
<div class="single_page_area">
     <div class="box-header"><h3 class="box-title">Produk Hukum</h3></div>
    <div class="row">
        <div class="col-sm-6">
            ...
            columns: [{
                ...
                },
                {
                    data: function (data) {
                        ...
                        return '<a href="<?= site_url('dokumen_web/unduh_berkas/') ?>' + data.id + '" class="btn bgsec btn-block" target="_blank" rel="noopener noreferrer" style="color:#fff;">Unduh</a>';
                    },
                    name: 'aksi',
                    searchable: false,
                    orderable: false,
