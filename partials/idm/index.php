...
<div class="boxmodule">
	<div class="boxmodule-head flexleft">
		...
		<h1 class="colorsec">Index Desa Membangun</h1>
	</div>
	<div class="boxmodule-padding idm">
		<div class="headpage flexcenter"><h1>Status IDM</h1></div>
						...
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-6 col-xs-12">
									<div class="idm-box bg-blue flexleft">
										<div>
								...
								<div class="col-lg-6 col-xs-12">
									<div class="idm-box bg-yellow flexleft">
										<div>
								...
								<div class="col-lg-6 col-xs-12">
									<div class="idm-box bg-red flexleft">
										<div>
								...
								<div class="col-lg-6 col-xs-12">
									<div class="idm-box bg-green flexleft">
										<div>
								...
								<div class="col-lg-12 col-xs-12">
									<div class="table-responsive" style="margin:15px 0;">
										<table class="table table-bordered table-striped dataTable table-hover table-mini">
											<tbody>
												<tr>
